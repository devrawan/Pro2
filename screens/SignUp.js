...
import { ScrollView, View, Text, StyleSheet, TouchableWithoutFeedback, Keyboard,KeyboardAvoidingView,SafeAreaView, Dimensions, Image, TextInput, TouchableOpacity } from 'react-native';
        ...
        <SafeAreaView style={styles.cont_2}>
            ...
            <View style={styles.btnsView_2}>
                <TouchableOpacity
                    ...
                    style={{
                        zIndex: 1, marginRight: -15, width: 162, height: 45,
                ...
                <TouchableOpacity
                    ...
                    style={{ width: 162, height: 45, backgroundColor: `${person == "doctor" ? "#3C67AF" : "#e0e0e0"}`, justifyContent: 'center', alignItems: 'center', borderRadius: 15 }}>
            ...
            {person == "patient" ?
                (
                    ...
                    <View style={{width:Widthh*0.9,marginTop:5}}>
                          <Text style={{ color: 'black', fontSize: 18, fontWeight: '400', paddingHorizontal: 5 }}> Confirm Password</Text>
                          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                  <TextInput
                                    secureTextEntry
                                    placeholder="****************"
                ...
                <View style={{width:Widthh*0.9,marginTop:5}}>
                          <Text style={{ color: 'black', fontSize: 18, fontWeight: '400', paddingHorizontal: 5 }}>Phone number </Text>
                            <TextInput
                             placeholder="282765432"
                                style={{ fontSize: 20, marginVertical: 8, paddingHorizontal: 10, paddingTop: 3, width: Widthh * 0.90, height: 45, borderWidth: 1, borderRadius: 10, borderColor: '#999999' }} />
                  </View>
...
<KeyboardAvoidingView 
                    ...
                    <View style={styles.formView_2}>
                        ...
                        <View style={{width:Widthh*0.9,marginTop:5}}>
                        <Text style={{ color: 'black', fontSize: 18, fontWeight: '400', paddingHorizontal: 5 }}>Name</Text>
                        <TextInput
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', paddingHorizontal: 10,marginVertical:15 }}>
                <View style={{ justifyContent: 'center', flexDirection: 'row', alignItems: 'center' }}>
                    <Image source={images.editt} style={{ width: 20, height: 20, resizeMode: 'contain', marginHorizontal: 5 }} />
                    <Text style={{ color: 'black' }}> I accept the terms of use and privacy policy </Text>
                </View>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 10, flexDirection: 'row' }}>
                   ...
                   onPress={()=>navigation.navigate('Login')}
                    >
                        <Text style={{ color: '#3C67AF', fontSize: 14, fontWeight: '500', marginTop: 5 }}> Login</Text>
